...
class PanitiaIntiController extends Controller
{
    public function homePanitiaIntiShow(){
        ...
        // dd($checkSeragam);
        return view('pages.panitia.panitia-inti.home-panitia-inti', compact('users', 'pendaftaran', 'dokumen', 'penanggungjawab', 'pembayaran', 'seleksi', 'wawancara', 'sistem', 'periodic', 'roles', 'seragam', 'checkWawancara', 'checkSeragam'));
    }
