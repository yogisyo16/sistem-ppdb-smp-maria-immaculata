...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dokumen/siswa/bukti/{id}', [UploadDokumenController::class, 'pembayaranTidakValid'])->name('pembayaranTidakValid')->middleware('role:siswa');
    Route::post('/dokumen/siswa/bukti/submit/{id}', [UploadDokumenController::class, 'pembayaranTidakValidSubmit'])->name('pembayaranTidakValidSubmit')->middleware('role:siswa');
    // Route::post('/dokumen/siswa/bukti/submit/{id}');
