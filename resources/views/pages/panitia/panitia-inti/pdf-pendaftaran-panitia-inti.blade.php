...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pdf-page.css') }}">
...
<body>
    <div class="container-md">
        <div class="container mt-5">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th colspan="2"><h4>Informasi Pribadi</h4></th>
                </tr>
                <tr>
                    <th>Nama Lengkap:</th>
                ...
                <tr>
                    <th colspan="2"><h4 class="mt-4">Informasi Asal Sekolah</h4></th>
                </tr>
                <tr>
                    <th>NISN:</th>
                    <td>{{ $daftar->nisn }}</td>
                ...
                <tr>
                    <th colspan="2"><h4 class="mt-4">Nilai Rapor SD</h4></th>
                </tr>
                <tr>
                ...
                <tr>
                    <th colspan="2"><h4 class="mt-4">Nilai ASPD DIY</h4></th>
                </tr>
                <tr>
                    <th>Nilai Membaca:</th>
                ...
                @endif
                <tr>
                    <th colspan="2"><h4 class="mt-4">Informasi Orang Tua/Wali </h4></th>
                </tr>
    ...
    <div class="container-md mt-5 page-break">
        <div class="container mt-5">
            @foreach ($pendaftaran as $daftar)
            <img class="img-bukti" src="{{ public_path('storage/' . $daftar->file_bukti_pembayaran_pendaftaran) }}" alt="File Image">
            @endforeach
        </div>
    </div>
