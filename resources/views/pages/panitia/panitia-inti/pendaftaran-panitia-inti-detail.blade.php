...
<div class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Total Nilai Kelas V Semester 1</th>
            <td>{{ $daftar->nilai_rapot_matematika_klsv_smt1 + $daftar->nilai_rapot_bhsindo_klsv_smt1 +  $daftar->nilai_rapot_ipa_klsv_smt1 + $daftar->nilai_rapot_ips_klsv_smt1}}</td>
        </tr>
        <tr>
            <th>Rata - Rata Kelas V Semester 1</th>
            <td>{{ ($daftar->nilai_rapot_matematika_klsv_smt1 + $daftar->nilai_rapot_bhsindo_klsv_smt1 +  $daftar->nilai_rapot_ipa_klsv_smt1 + $daftar->nilai_rapot_ips_klsv_smt1)/4 }}</td>
        </tr>
        <tr>
