        ...
        <div class="container-fluid my-2">
            <div class="container-md">
                <div class="col mx-2 text-center">
                    ...
                    <span id="badge-for-progress-2" class="badge rounded-pill badge-for-progress-2 mx-2 my-3 {{ in_array(Route::currentRouteName(), ['dokumenSiswashow1', 'dokumenSiswashow2']) ? 'text-bg-light' : 'text-bg-secondary' }}">Upload Dokumen</span>
